Pod::Spec.new do |s|
  ...
  s.subspec 'PMAnimationQueue' do |ss|
  	ss.source_files = 'Classes/ios/PMAnimationQueue/*.{h,m}'
  end
  
  s.subspec 'PMOrderedDictionary' do |ss|
  	ss.source_files = 'Classes/ios/PMOrderedDictionary/*.{h,m}'
  end
  
  s.subspec 'PMPair' do |ss|
  	ss.source_files = 'Classes/ios/PMPair/*.{h,m}'
  end
  
  s.subspec 'PMProtocolInterceptor' do |ss|
  	ss.source_files = 'Classes/ios/PMProtocolInterceptor/*.{h,m}'
  end
  
  s.subspec 'PMImageFilmstrip' do |ss|
  	ss.source_files = 'Classes/ios/PMImageFilmstrip/*.{h,m}'
  end
